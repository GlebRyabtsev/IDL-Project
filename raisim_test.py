...
raisim.World.setLicenseFile("C:/tools/raisim_build/bin/rsc/activation.raisim")
world = raisim.World()
...
laikago = server.addVisualArticulatedSystem("v_laikago", "C:/tools/raisim_build/bin/rsc/laikago/laikago.urdf")
